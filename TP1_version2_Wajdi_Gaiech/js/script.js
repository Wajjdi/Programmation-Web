...
function init() {
  ...
  grille.showCookies();
  let clickerButton = document.getElementById("groupe");
  clickerButton.addEventListener("click", lol);
}

function lol() {
  document.getElementById("groupe").textContent = "Oh wow, you clicked me!";
}
